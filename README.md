...
что нужно сделать: 
 -  вы создаёте репозиторий в котором будут решения 
 -  вам нужно сделать 3 консольные команды, которые будут выдавать результат

что я ожидаю как результат:  
 - ссылка на репозиторий
 - мануал, как это запускать 

как я буду проверять: 
 - проверю что запускается 
 - проверю что результат правильный 
 - почитаю код
 -->
